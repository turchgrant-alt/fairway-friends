    ...
    <div className="space-y-4">
      ...
      <div className="grid gap-3 lg:grid-cols-2">
        {settingGroups.map(group => (
          <div key={group.title} className="rounded-2xl border border-[hsl(var(--golfer-line))] bg-white p-4 shadow-[0_24px_70px_-48px_rgba(12,25,19,0.35)]">
            <p className="mb-3 text-xs font-medium uppercase tracking-wider text-muted-foreground">{group.title}</p>
            <div className="overflow-hidden rounded-xl bg-[hsl(var(--golfer-cream))]">
        ...
        <div className="rounded-2xl border border-[hsl(var(--golfer-line))] bg-[hsl(var(--golfer-deep))] p-4 text-white shadow-[0_24px_70px_-48px_rgba(12,25,19,0.35)] lg:col-span-2">
          <p className="text-xs font-semibold uppercase tracking-[0.24em] text-white/55">GolfeR account</p>
          <p className="mt-2 text-lg">Your rankings, friends, and sign-in stay with you.</p>
