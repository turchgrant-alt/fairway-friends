  ...
  return (
    <div className="min-h-screen bg-background px-6 pb-8 pt-4">
      ...
      <form onSubmit={handleLogin} className="mt-8 space-y-4">
        <div>
          ...
          <input
            ...
            className="mt-1.5 w-full rounded-lg border border-input bg-card px-4 py-3 text-sm text-card-foreground outline-none transition-colors focus:border-primary focus:ring-1 focus:ring-primary"
        ...
        <div>
          ...
          <div className="relative mt-1.5">
            <input
              ...
              className="w-full rounded-lg border border-input bg-card px-4 py-3 pr-10 text-sm text-card-foreground outline-none transition-colors focus:border-primary focus:ring-1 focus:ring-primary"
              placeholder="••••••••"
            />
      ...
      <p className="mt-8 text-center text-sm text-muted-foreground">
        ...
        <button onClick={() => navigate('/signup')} className="font-semibold text-primary">Sign up</button>
      </p>
    </div>
  );
}
